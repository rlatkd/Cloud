...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/infrastructure1.jpg">

## 1.5 전체 구조

### (1) Frontend GitHub Repository

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/devopsReact.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/devopsFlask.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/terraform/devopsTerraform.jpg">
...
## <img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/addReactUser.jpg">

### (2) Amazon S3 설정

### (2-1) Amazon S3 생성

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/makeS3Bucket1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/makeS3Bucket2.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/makeS3Bucket3.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/makeS3Bucket4.jpg">

### (2-2) 정적 웹 사이트 호스팅 활성화

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/staticWebHostingActivate1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/staticWebHostingActivate2.jpg">

### (2-3) 버킷과 객체에 퍼블릭 액세스 권한 부여

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/addS3PublicAccessAutority1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/addS3PublicAccessAutority2.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/addS3PublicAccessAutority3.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/addReactCodeToBucket1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/addReactCodeToBucket2.jpg">

### (4) 서비스 정상 작동 확인

### (4-1) 브라우저로 Amazon S3의 웹 사이트 앤드포인트로 접근

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/bucketEndpoint.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/OAI.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/originShield1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/originShield2.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/settings1.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/settings2.jpg">

- 캐시 키 및 원본 요청은 **CachingOptimized**를 선택 -> 대부분의 상황에서 적절한 캐시 정책을 바로 적용할 수 있음

### (3-3) 설정-3

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/settings3.jpg">

- 보통 모든 엣지 로케이션에서 사용(최고의 성능)을 사용하면 되지만, 비용을 절약해야 하는 상황이거나 서비스 지역 타겟이 정해져 있을 때 적절한 항목을 선택하면 됨

### (3-4) 설정-4

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/settings4.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/settings5.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/connectedFrontend.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/addFlaskUser.jpg">

### (1-2) VPC 생성

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/createVPC.jpg">

### (1-3) 보안 그룹 생성

`rlatkdFlaskWebServerSg`

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/createSg.jpg">

### (2) Amazon EC2 설정

### (2-1) Public Subnet에 Amazon EC2를 생성

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/createEC2Instance1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/createEC2Instance2.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/createEC2Instance3.jpg">

### (2-2) Amazon EC2의 Public IP 주소로 SSH 접속

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/accessSSH.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/installApache.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/database/addMySQLUser.jpg">

### (2) Amazon RDS 설정

### (2-1) Private Subnet에 Amazon RDS를 생성

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/database/createRDS1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/database/createRDS2.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/database/createRDS3.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/database/createRDS4.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/database/createRDS5.jpg">

### (2-2) Amazon RDS에서 Amazon EC2(Flask)로의 연결 설정

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/database/connectEC2Instance1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/database/connectEC2Instance2.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/database/connectEC2Instance3.jpg">

- Amazon EC2(Flask)는 Backend server를 포함하며 Bastion Host 역할을 함

### (2-3) Bastion Host

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/database/bastionHost.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/database/connectWorkbench.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/database/createSchemaTable.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/terraform/tfUser.jpg">

### (1-2) 액세스 키 생성

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/terraform/tfAccessKey.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/terraform/vpc.jpg">

### (2) Amazon EC2 확인

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/terraform/ec2.jpg">

### (3) Amazon S3확인

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/terraform/s3.jpg">

### (4) Amazon RDS 확인

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/terraform/rds.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/accessKey1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/accessKey2.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/accessKey3.jpg">

### (1-2) GitHub Repository(DevOps-React)에 Secret을 추가

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/githubReposSecrets.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/deploy.jpg">

### (2-3) 배포 성공

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/deploySuccess.jpg">

### (2-4) 수정된 코드가 자동으로 배포되어 적용된 것을 확인

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/client/commitedReact.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/codedeployEC2role1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/codedeployEC2role2.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/codedeployEC2role3.jpg">

### (1-3) AWS Code Deploy Agent 설치

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/codedeployAgent.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/createCodeDeployGroupRole1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/createCodeDeployGroupRole2.jpg">

### (1-6) AWS CodeDeploy 애플리케이션과 배포 그룹을 생성

**애플리케이션**

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/codedeployApp.jpg">

**배포 그룹**

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/codedeployGroup1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/codedeployGroup2.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/codedeployGroup3.jpg">

### (1-7) AWS CodeDeploy Agent가 앱을 가져올 Amazon S3 생성

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/flaskS3Bucket.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/accessKey1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/accessKey2.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/accessKey3.jpg">

### (2-2) GitHub Repository(DevOps-Flask)에 Secret을 추가

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/githubReposSecrets.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/deploy.jpg">

### (3-2) 배포 성공

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/deploySuccess1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/deploySuccess2.jpg">

### (3-3) 수정된 코드가 자동으로 배포되어 적용된 것을 확인

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/commitedFlask.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/cannotAccess.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/internalServerError.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/dummyData.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/reDeployJSON.jpg">

## 5.4 Frontend - Backend

### (1) Frontend와 Backend 연동이 안 됨

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/disconnectFrontend1.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/server/disconnectFrontend2.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/emptyDatas1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/emptyDatas2.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/emptyDatas3.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/emptyDatas4.jpg">

### (1-2) 임의의 아이디와 비밀번호로 로그인 시도

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/randUser.jpg">

### (1-3) 테스트용 임의의 계정을 생성하여 로그인

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/testUser.jpg">

### (1-4) 데이터베이스에 추가된 것을 확인

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/testUserDb.jpg">

### (1-5) 토근 정상 발급 확인

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/token1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/token2.jpg">

### (1-6) 로그인 상태에서 경매 물품 등록 글쓰기

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/createBoard1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/createBoard2.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/retry.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/server.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/testDir.jpg">

### (4-2) GitHub commit을 하면 빈 디렉터리는 commit되지 않음

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/commitedGitHub1.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/commitedGitHub2.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/awsCodeDeploy.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/normal1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/normal2.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/buyTshirt1.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/buyTshirt2.jpg">

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/buyTshirt3.jpg">

### (3-2) 작동 확인

**2023-11-24 am10:30 전**

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/preHistory1.jpg">

**2023-11-24 am10:30 후**

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/preHistory2.jpg">
...
<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/beforeCache.jpg">

### (3) 캐시 설정 후

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/afterCache1.jpg">

### (3-1) Amazon S3로 전송한 파일에 불필요한 파일 포함 여부

<img src="https://github.com/rlatkd/SSGBay-v4/blob/main/assets/preview/afterCache2.jpg">
